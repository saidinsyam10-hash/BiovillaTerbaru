...
export default function App() {
  ...
  const [hasStarted, setHasStarted] = useState<boolean>(() => {
    return localStorage.getItem(STORAGE_KEY_STARTED) === 'true';
  });
  ...
  useEffect(() => {
    localStorage.setItem(STORAGE_KEY_STARTED, String(hasStarted));
  }, [hasStarted]);
  ...
  const handleStageComplete = (stageId: string) => {
    ...
    // Sync student progress with auth store
  ...
  // Diarahkan ke Dashboard Guru: melihat daftar siswa, progres tiap siswa, dan mengelola konten (video/gambar per level)
